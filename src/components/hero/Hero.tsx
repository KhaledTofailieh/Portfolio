      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-foreground mb-6 leading-tight">
              {/* Hi, I&apos;m <br /> */}
              <span className="gradient-text whitespace-nowrap">{personalInfo.personal.name}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start">
              ...
              >
                <a
                  ...
                  download={`${personalInfo.personal.name.replace(/\s+/g, '_')}_Resume.pdf`}
                >
